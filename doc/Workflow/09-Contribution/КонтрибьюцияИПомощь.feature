...
Функциональность: Использование шаблонов и обработок в реальной работе
	Как специалист по 1С с любой ролью
	И активным аккаунтом на GitHub 
...
Сценарий: Создание запросов на изменение или улучшение функциональности
	...
	И описываю необходимое в формате BDD, используя ключевые слова Gherkin
...
Сценарий: Регистрация ошибок в Vanessa-Stack
	...
	Тогда я создаю Issue в проектах https://github.com/silverbulleters
	И вместе с этим указываю ветку, где воспроизводится ошибка (master или develop)
